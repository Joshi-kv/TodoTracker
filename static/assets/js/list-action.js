                ...
                success:function(response){
                    if(response.status === 'success'){
                        ...
                        table.row(rowIndex).data([
                            ...
                            `
                            <div class="d-flex">
                                <button class="btn btn-sm btn-primary mx-2" id="listUpdateBtn"  data-list-edit="${updatedList.list_id}" data-bs-toggle="modal" data-bs-target="#listUpdateModal" >
                                <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn btn-sm btn-danger mx-2" data-bs-toggle="modal" data-list-delete="${updatedList.list_id}" data-bs-target="#deleteListModal" >
