...
urlpatterns = [
    ...
    path('check-duplicates/',views.CheckProjectFileDuplicates.as_view(),name='check-duplicates'),
    path('upload-project/',views.ProjectFileUploadView.as_view(),name='upload-project'),
    ...
    path('project/lists/issues/<int:list_id>/',views.IssuePageView.as_view(),name='issue-page'),
    path('lists/issues/<int:list_id>/',views.IssueListView.as_view(),name='issue-list'),
    path('lists/create-issue/<int:list_id>/',views.IssueCreateView.as_view(),name='issue-create'),
    ...
    path('delete-issue/<int:list_id>/',views.DeleteIssueView.as_view(),name='delete-issue'),
    path('project/lists/issue-detail/<int:list_id>/',views.IssueDetailPage.as_view(),name='issue-detail'),
    path('tasks/',views.TodoPageView.as_view(),name='todo-page'),
