...
urlpatterns = [
    ...
    path('filter-deactivated-tasks/',views.DeactivatedTaskFilterView.as_view(),name='filter-deactivated-tasks'),
    path('deactivated-tasks/',views.DeactivatedTaskView.as_view(),name='deactivated-tasks'),
