...
urlpatterns = [
    ...
    path('lists/issues/<int:project_id>/',views.IssueListView.as_view(),name='issue-list'),
    path('lists/create-issue/<int:project_id>/',views.IssueCreateView.as_view(),name='issue-create'),
